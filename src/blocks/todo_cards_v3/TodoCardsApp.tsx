...
export function TodoCardsApp(){
    ...
    <Select>
        ...
        <SelectContent>
            {user_list.map(value => <SelectItem key = {value} value={value}>{value}</SelectItem>)}
        </SelectContent>
    </Select>
    ...
    <Select>
      ...
      <Slider
        ...
        step={1}
        onValueChange={(value) => {console.log(value); dispatch({type: "SET_ID_RANGE", payload:value as [number, number]});}}
      />
